...
Route::group( array('middleware'=>'web') ,function(){
  ...
  Route::get('/attendance','DashboardController@index');
	...
	Route::post('/examsList/shedule/term','ExamsListController@termSave');
	Route::get('/examsList/termChange/{term}','ExamsListController@termSelect');
	// Route::get('/examsList/classSheduleList/{id}','ExamsListController@classSheduleLists');
