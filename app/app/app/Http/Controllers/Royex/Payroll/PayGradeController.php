...
use App\Http\Requests\Royex\PayGradeRequest;
...
use App\Models2\Royex\Allowance;

use App\Models2\Royex\Deduction;
    ...
    public function update(PayGradeRequest $request, $id)
    {
        ...
        try{
            DB::beginTransaction();
                ...
                DB::table('royex_pay_grade_to_allowance')->where('pay_grade_id',$id)->delete();
                DB::table('royex_pay_grade_to_deduction')->where('pay_grade_id',$id)->delete();
