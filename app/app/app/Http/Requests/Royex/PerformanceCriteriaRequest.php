    ...
    public function rules()
    {
        ...
        if(isset($this->performanceCriteriaId)){
            return [
                ...
                'performance_criteria_name'  => 'required|unique:royex_performance_criteria,performance_criteria_name,'.$this->performanceCriteriaId.',performance_criteria_id'
            ];
        }
        return [
            'performance_category_id'=>'required',
            'performance_criteria_name'=>'required|unique:royex_performance_criteria',
        ];
    }
