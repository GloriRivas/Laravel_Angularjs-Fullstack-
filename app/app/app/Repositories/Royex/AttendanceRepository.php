...
class AttendanceRepository
{
    ...
    public function findAttendanceSummaryReport($month){
        ...
        $employees  = Employee::select(DB::raw('CONCAT(COALESCE(royex_employee.first_name,\'\'),\' \',COALESCE(royex_employee.last_name,\'\')) AS fullName'),'designation_name','finger_id','employee_id')
        ...
        $attendance = DB::table('royex_view_employee_in_out_data')->select('finger_print_id','date')->whereBetween('date',[$start_date,$end_date])->get();
