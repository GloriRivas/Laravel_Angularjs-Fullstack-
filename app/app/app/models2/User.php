...
class User extends Authenticatable {
	...
	public function getSectionsAttribute() {
		$data = Section::where('classTeacherId', 'LIKE', '%"'.$this->attributes['id'].'"%')->get()->toArray();
		return $data;
	}

	public function getClassesAttribute() {
		$data = MClass::where('classTeacher', 'LIKE', '%"'.$this->attributes['id'].'"%')->get()->toArray();
		return $data;
	}
	...
	public static function getStudentIdsOfTeacherByTeacherId($teacher_id) {
		$classes_ids = MClass::getClassesIdsByTeacherId($teacher_id);
