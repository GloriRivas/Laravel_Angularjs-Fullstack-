...
class DashboardInit {
	...
	public function __construct(){
		...
		$this->panelItems = array(
			...
			"examslist"=>array("title"=>"exams Schedule","url"=>URL::to('portal#/examsList'),"role_perm"=>array("examsList.list","examsList.addExam","examsList.editExam","examsList.delExam","examsList.examDetailsNot","examsList.showMarks","examsList.controlMarksExam"),"icon"=>"mdi mdi-playlist-check" ),
			// "marksheet"=>array("title"=>"Marksheet","url"=>URL::to('portal#/students/marksheet'),"role_perm"=>array("Marksheet.Marksheet"),"icon"=>"mdi mdi-grid" ),
