...
use App\Models2\Royex\PayGradeToAllowance;

use App\Models2\Royex\PayGradeToDeduction;
...
class PayrollRepository
{
    ...
    {
        return  PayGradeToAllowance::select('royex_allowance.*')
                                     ->join('royex_allowance', 'royex_allowance.allowance_id', '=', 'royex_pay_grade_to_allowance.allowance_id')
    ...
    {
        return  PayGradeToDeduction::select('royex_deduction.*')
                                    ->join('royex_deduction', 'royex_deduction.deduction_id', '=', 'royex_pay_grade_to_deduction.deduction_id')
                                    ->where('pay_grade_id',$pay_grade_id)->get();
    }
